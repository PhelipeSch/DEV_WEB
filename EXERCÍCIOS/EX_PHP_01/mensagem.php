...
<form action="mensagem.php" method="POST">
    <input type="submit" value="Ver última mensagem" name="last_msg">
</form>

<br>

<form action="mensagem.php" method="POST">
    <input type="submit" value="Ver últimas mensagem" name="msgs">
</form>
...
if (isset($_POST['last_msg'])) {
    $linhas = file("mensagem.txt");
    $ultima = trim(end($linhas));
    echo "Última mensagem: " . $ultima;
}
